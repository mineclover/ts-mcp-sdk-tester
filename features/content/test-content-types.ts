    ...
    async ({ contentType }) => {
      try {
        ...
        if (contentType === "image" || contentType === "all") {
          ...
          const base64Image = "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAC0lEQVQIHWP8/x8AAwMCAO+ip1sAAAAASUVORK5CYII=";
          content.push({
            type: "image" as const,
            data: base64Image,
            mimeType: "image/png",
        ...
        if (contentType === "audio" || contentType === "all") {
          ...
          const base64Audio = "UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACBhYqFbF1fdJivrJBhNjVgodDbq2EcBj+a2/LDciUFLIHO8tiJNwgZaLvt559NEAxQp+PwtmMcBjiR1/LMeSwFJHfH8N2QQAoUXrTp66hVFApGn+DyvmAaA";
          content.push({
            type: "audio" as const,
            data: base64Audio,
            mimeType: "audio/wav",
        ...
        if (contentType === "resource" || contentType === "all") {
          content.push({
            ...
            resource: {
              ...
              text: "This is a resource content example with structured data:\n{\n  \"name\": \"Sample Resource\",\n  \"type\": \"example\",\n  \"timestamp\": \"" + new Date().toISOString() + "\"\n}",
